-- EUDM-MSFT-MPS-Line-Items Query - MASTER
...
SELECT  mediaplanlines.ss_mpli_id AS ADT_CAMPAIGN_ID,
        ...
        mediaplans.media_plan_id AS MEDIA_PLAN_ID,
        ...
        CASE 
          WHEN mediaplans.reporting_source_id = 4 THEN 'N' 
          ELSE 'Y' 
        END
          AS THIRD_PARTY_STATS_FLAG,
        ...
        product.delivery_type_id AS DELIVERYTYPEID,
        'N' AS TARGETED_FLG, 
        CASE
